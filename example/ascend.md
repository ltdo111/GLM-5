...
## PD disagree server run script 
### PD分离4机服务拉起
#### 1.2.1、prefill双机实例拉起脚本
##### 1.2.1.1、Prefill master节点启动脚本：
```
#!/bin/bash
set -e
...
tail -f log/node_0.log
```
### 1.2.2、decode双机实例拉起脚本
#### 1.2.2.1、Decode master节点启动脚本：
```
#!/bin/bash
set -e
...
## Latency Benchmark
### 2.2.1、Custom Dataset - input/output configuration
